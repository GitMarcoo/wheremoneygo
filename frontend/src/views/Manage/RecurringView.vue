<template>
    <div class="width-800 ml-10 sm:ml-auto mr-10 sm:mr-auto justify-center ">
      <h1 class="text-4xl font-bold text-gray-800 dark:text-white text-center mt-5">Recurring Budgets</h1>
      <section class="mt-3 flex flex-row justify-center">
        <h1 class="text-3xl font-bold text-gray-800 dark:text-white flex m-auto ml-2 mr-2">
          Show in interval: 
        </h1>
        <IntervalDropDown
