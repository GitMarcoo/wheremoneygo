        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                <li class="self-center">
                    <router-link  to="/" class="navItem" aria-current="page">Home</router-link>
                </li>
                <li class="self-center">
                    <router-link  to="/about" class="navItem">About</router-link>
                </li>
                <li class="self-center">
                    <router-link  to="/manage" class="navItem ">Manage</router-link>
                </li>
                <li>
                    <button @click="toggleDarkMode" id="theme-toggle" type="button" class="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5">
                        <svg v-if="!darkModeManager.inDarkMode.value" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
