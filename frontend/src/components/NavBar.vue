            ...
            <li class="self-center" v-if="user?.roles">
                ...
                <div id="dropdownNavbar" class="z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-400" aria-labelledby="dropdownLargeButton">
                      <li>
                        <router-link to="/manage" class="navItem block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"> Dashboard </router-link>
                      </li>
                      <li>
                        <router-link to="/manage/recurring" class="navItem block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"> Recurring </router-link>
                      </li>
                      <li>
                        <router-link to="/manage/savings" class="navItem block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"> Savings </router-link>
                      </li>
                    </ul>
                </div>
            </li>
